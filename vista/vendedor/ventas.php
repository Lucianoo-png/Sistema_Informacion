...
<<<<<<< HEAD
              <div style="display:flex;align-items:center;justify-content:space-between;gap:6px;
                ...
                ${bloqueado
                  ? `<span style="font-size:14px;font-weight:800;color:var(--primary)">${fmt(sub)}</span>`
                  : `<input type="number" value="${it.precio.toFixed(2)}" min="0.01" step="0.5"
                            style="width:80px;padding:4px 6px;font-size:13px;font-weight:700;
              ...
              <div style="display:flex;justify-content:flex-end;align-items:center;gap:6px;margin-top:5px">
                <button onclick="toggleEditarKg('${cod}')"
                        style="background:none;border:1.5px solid var(--border);border-radius:5px;
                               cursor:pointer;font-size:10px;color:var(--text-muted);padding:2px 8px">
...
<<<<<<< HEAD
            ...
            return `
            <div class="cart-item">
              <div class="ci-top" style="margin-bottom:7px">
                <span class="ci-name" style="font-size:12px;font-weight:600;
                      flex:1;line-height:1.3">${esc(it.nombre)}</span>
                <span class="ci-total" style="font-size:14px;font-weight:800;
                      color:var(--primary);white-space:nowrap">${fmt(sub)}</span>
              </div>
              <div style="display:flex;align-items:center;justify-content:space-between;gap:6px">
                ...
                <div style="display:flex;align-items:center;gap:6px">
                  <div class="qty-ctrl">
                    ...
                    <span style="min-width:26px;text-align:center;font-weight:700">${it.cantidad}</span>
                    <button onclick="cambiarCant('${cod}',+1)">+</button>
                  </div>
